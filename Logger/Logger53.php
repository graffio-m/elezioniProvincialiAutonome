...
class Logger
{
    ...
    /**
     * $optionDate
     * @var string $dateFormat of the format used for the log.txt file
     */
    protected static $optionDate = 'd-M-Y';


    /**
     * $optionTime - 
     * @var string $logFormat used for the time of a single log event
     */
    protected static $optionTime = 'H:i:s d-M-Y';
    ...
    public static function createLogFile()
    {
        ...
        if (!is_writable(static::$log_file)) {
            ...
            throw new Exception("ERROR: Unable to write to file! ". static::$log_file, 1);
        }
    }
